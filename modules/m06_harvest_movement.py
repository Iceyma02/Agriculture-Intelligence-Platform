...
def layout():
    ...
    fig_type = go.Figure(go.Bar(
        ...
        marker=dict(color=PALETTE[:len(by_type)]),
        text=[fmt_tons(v) for v in by_type["quantity_tons"]],
    ...
    table = html.Table([
        html.Thead(html.Tr([
            ...
            for h in ["Date","Farm","Crop","Movement Type","Qty","Destination","Status"]
        ])),
        html.Tbody(rows),
    ...
    return html.Div([
        ...
        card([
            html.Div("🚚  Recent Movements", style={"color":"#86efac","fontWeight":"600","marginBottom":"14px","fontSize":"0.9rem"}),
